...
def test_get_gender_and_age_range():
    assert get_gender_and_age_range("#population+m+total") == ("m", "all")
    ...
    assert get_gender_and_age_range("#inneed+age0_17") == ("all", "0-17")
...
def test_get_min_and_max_age():
    assert get_min_and_max_age("all") == (None, None)
